      ...
      <div className="hero-body">
        <div className="container has-text-centered">
          ...
          <h2 className="subtitle">
            ...
            From the first time I played on a computer I just had a drive to learn more about them.<br />
            ...
            As well as on graduation from high school building my own computer with my graduation money.<br />
