      ...
      <div className="hero-body">
        <div className="container has-text-centered">
          ...
          <h2 className="subtitle">
            ...
            This curiosity bloomed when I hit high school and start taking programming classes, as well as working with the IT department to keep the school computers maintained.
            ...
            After high school I took a few years off and started working in the food industry.  Now that I have savings and time I decided to not go the traditional college route and looked into fullstack development programs.
            I ended up at Thinkful because they were one of the only programs that would work around my work schedule. Thanks to Thinkful, not only do I get to expand my knowledge, but I finally get to turn my passion for computers into a career.
          </h2>
        </div>
      </div>
    )
