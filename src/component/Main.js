        ...
        <div className="container has-text-centered">
          ...
          <div className="columns">
            <div className="column">
              ...
              <a href="https://ibb.co/iXznFA" target="_blank" rel="noopener noreferrer"><img className="project" src="https://preview.ibb.co/d8uMaA/LOL.jpg" alt="League of Legends recent players" border="0" /></a>
            ...
            <div className="column">
              ...
              <a href="https://ibb.co/gYPyNq" target="_blank" rel="noopener noreferrer"><img className="project" src="https://preview.ibb.co/f1oQ2q/drink.jpg" alt="Bartenders Blackbook" border="0" /></a>
            ...
            <div className="column">
              ...
              <a href="https://ibb.co/DCnhPLF" target="_blank" rel="noopener noreferrer"><img className="project" src="https://i.ibb.co/QNGL7XV/Untitled.jpg" alt="Personal Publication" border="0" /></a>
